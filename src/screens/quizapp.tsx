...
export default function QuizApp() {
    ...
    const checkAnswer = (answer: string, i: number) => {
                    ...
                    : isDone
                        ? <>
                            <div className='col-span-5 sideScreen p-12 bg-gray-300 h-screen text-center'>
                                <div className=' bg-white p-3 m-12 rounded-xl'>
                                    ...
                                    <p className='text-2xl p-5'>Your Score is : <span className='font-bold'>{score}</span></p>
                        ...
                        : <div className='col-span-5 p-12 bg-gray-300 h-screen text-center'>
                            ...
                            <div className='grid grid-cols-2'>
                                {model && model[currentQuestion]?.options.map((x: any, i: any) => (
                                    <div key={i}>
                                        <div className='m-4'>
                                            <ABButton className='w-80' label={x}
                                                onClick={() => nextQuestion(x)} />
                                        </div>
                                    </div>
                                ))}
                            </div>
